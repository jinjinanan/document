...
class LintMiddleware(object):
    ...
    ::
        ...
        testApp = LintMiddleware(testApp)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI testApp required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI testApp allowed'),
                 stacklevel=2)
