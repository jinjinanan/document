...
class CGIRootFix(object):
    ...
    and you have problems with your testApp root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your testApp is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your testApp, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the testApp.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        testApp = HeaderRewriterFix(testApp, remove_headers=['Date'],
