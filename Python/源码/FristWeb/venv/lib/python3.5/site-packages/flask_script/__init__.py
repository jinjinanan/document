...
class Manager(object):
    ...
    def add_option(self, *args, **kwargs):
        ...
        The arguments are then passed to your function, e.g.::
            ...
            def create_my_app(config=None):
                testApp = Flask(__name__)
                if config:
                    testApp.config.from_pyfile(config)
            ...
            @manager.command
            def mycommand(testApp):
                testApp.do_something()
    ...
    def __call__(self, app=None, **kwargs):
        ...
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no testApp here. This is unlikely to work.")
    ...
    # def foo(self, testApp, *args, **kwargs):
    #     print(args)
    ...
    def shell(self, func):
        ...
        Decorator that wraps function in shell command. This is equivalent to::
            ...
            def _make_context(testApp):
                return dict(testApp=testApp)

            manager.add_command("shell", Shell(make_context=_make_context))

        The decorated function should take a single "testApp" argument, and return
        a dict.
    ...
    def handle(self, prog, args=None):
        ...
        for handle in func_stack:
            ...
            # pass only safe testApp config keys
