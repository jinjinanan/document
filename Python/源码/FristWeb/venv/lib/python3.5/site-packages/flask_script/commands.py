...
class Command(object):
    ...
    def __init__(self, func=None):
        ...
        # first arg is always "testApp" : ignore
    ...
    def __call__(self, app=None, *args, **kwargs):
        """
        Handles the command with the given testApp.
...
class Shell(Command):
    ...
    :param make_context: a callable returning a dict of variables
                         ...
                         returns a dict consisting of just the testApp.
...
class Server(Command):
    """
    Runs the Flask development server i.e. testApp.run()
    ...
    help = description = 'Runs the Flask development server i.e. testApp.run()'
